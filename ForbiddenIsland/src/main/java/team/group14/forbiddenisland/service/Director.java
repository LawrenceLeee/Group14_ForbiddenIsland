...
public class Director {
    ...
    public void init(Stage stage) {
        ...
        stage.getIcons().add(new Image(getClass().getResource("/team/group14/forbiddenisland/images/icon.jpg").toExternalForm())); //E:/Code/JavaCode/ForbiddenIsland/src/main/resources/team/group14/forbiddenisland/images/icon.jpg
